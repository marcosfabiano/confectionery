...
import com.fabianoapp.confectionery.services.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Page<ProductMinDTO>> findAll(
            ...
            @RequestParam(name = "productType", defaultValue = "") ProductType productType,
            Pageable pageable) {
        Page<ProductMinDTO> dto = service.findAll(name, productType, pageable);
        return ResponseEntity.ok(dto);
    }
